...
class Edrone():
    ...
    def __init__(self):
        ...
        # after tuning and computing corresponding PID parameters, change the parameter

        self.Kp = [930, 930, 6900]
        self.Ki = [0.003, 0.003, 0.8]
        self.Kd = [4000, 4000, 1500]
