...
class edrone_gripper():
    ...
    def check(self):
        ...
        if (self.box_index != -1 and self.drone_index !=-1 ):
            if(abs(self.drone_coordinates[0] - self.box_coordinates[0]) < 0.15 and abs(self.drone_coordinates[1] - self.box_coordinates[1]) < 0.15 and (self.box_coordinates[2]-self.drone_coordinates[2])>0.105 and (self.box_coordinates[2]-self.drone_coordinates[2])>0):
